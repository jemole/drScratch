...
urlpatterns = (
    ...
    url(r'^createOrganizationHash', 'app.views.createOrganizationHash',),
    #url(r'^registerOrganization$', 'app.views.registerOrganization',),
    ...
    url(r'^user$', 'app.views.signUpOrganization',),
    #url(r'^user/(\w+)', 'app.views.organizations',),
